...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "node_modules/.prisma/dheeranclients/global",
    ".prisma/dheeranclients/global",
  ]
...
path.join(process.cwd(), "node_modules/.prisma/dheeranclients/global/libquery_engine-darwin-arm64.dylib.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "node_modules/.prisma/dheeranclients/global/schema.prisma")
