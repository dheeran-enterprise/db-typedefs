...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "node_modules/.prisma/dheeranclients/franchise",
    ".prisma/dheeranclients/franchise",
  ]
...
path.join(process.cwd(), "node_modules/.prisma/dheeranclients/franchise/libquery_engine-darwin-arm64.dylib.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "node_modules/.prisma/dheeranclients/franchise/schema.prisma")
